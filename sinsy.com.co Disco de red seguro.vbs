' sinsy.com.co Disco de red seguro.vbs
'
...
' *************************************************************************
strURL = "\\sinsy.com.co@SSL@2078\DavWWWRoot" ' This is the URL to the WebDAV share.
strDomainPort = "sinsy.com.co@SSL@2078"
...
Sub ConfigureService()
   ...
   If colServiceList.Count = 1 Then
      ...
      Next
   Else
      WScript.Echo "No se pudo encontrar el servicio “WebClient”."
   End If
End Sub
...
Sub CreateShorty ()
   ...
   MsgBox "Conectándose a su disco de red ahora; esto tomará un minuto.", 64, "Conectándose al disco de red"

   strName = "sinsy.com.co Disco de red seguro"
